...
Op:function(a){return new H.ku(J.o7(a,1))}},
fP:{
"^":"a;kw",
...
this.E6(a,b)
P.HZ(this,z)},function(a){return this.K5(a,null)},"Lp","call$2","call$1","giO",2,2,12,13],
$isvs:true,
$isb8:true,
...
Sw:{
"^":"mW;v5,av,HV,qT",
gA:function(a){return new P.UQ(this,this.HV,this.qT,this.av,null)},
aN:function(a,b){var z,y,x
z=this.qT
...
$isiP:true,
static:{"^":"Oj,Vp,Ej,p2,ch,QC,Px,Yp,kc,Gi,k3,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
return z}}},
Hn:{
"^":"Tp:18;",
...
$isa6:true,
static:{"^":"Wt,S4,dk,Lo,zj,b2,q9,ts,Do,Cv,kT,IJ,D9,Vk,S8,yn",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},
P7:{
"^":"Tp:18;",
...
else return new W.dW(a)}}}}],["dart.isolate","dart:isolate",,P,{
"^":"",
IU:{
"^":"a;",
$isIU:true,
...
return y}return a}}}],["","file:///Users/nickbottomley/Desktop/dart-iframe/web/iframe.dart",,F,{
"^":"",
Iq:[function(){$.rs=document.querySelector("#compose-message")
$.v0=document.querySelector("#send-message")
$.rJ=document.querySelector("#dart-iframe")
$.iM=document.querySelector("#message-log")
var z=H.VM(new W.RO(window,C.ph.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(F.Jd()),z.Sg),[H.Kp(z,0)]).Zz()
J.mZ($.v0,"click",F.cl())},"call$0","eE",0,0,0],
WU:[function(a){var z=document.createElement("li",null)
z.textContent=J.Qd(a)
$.iM.appendChild(z)},"call$1","Jd",2,0,5],
K9:[function(a){J.Ih($.yK(),J.Vm($.rs),$.rA)},"call$1","cl",2,0,6]},1],])
...
$.rJ=null
$.iM=null
$.rA="http://127.0.0.1:3030/dart-iframe/web/index.html"
...
I.$lazy($,"parent","E7","yK",function(){return W.Pv(window.parent)})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"WE",void:true,args:[W.cx]},{func:"WW",void:true,args:[W.ea]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"yV",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"ZH",args:[J.im]},{func:"iR",args:[J.im,null]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
F3.prototype=$desc
F3.prototype.gRn=function(receiver){return receiver.data}
...
if($desc instanceof Array)$desc=$desc[1]
Sw.prototype=$desc
function UQ(Lz,dP,qT,Dc,fD){this.Lz=Lz
this.dP=dP
this.qT=qT
this.Dc=Dc
...
if($desc instanceof Array)$desc=$desc[1]
xL.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,dU,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,BK,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,OF,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,dx,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,WZ,ET,df,zU,K8,xj,dE,Zc,dT,Pq,LN,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,bL,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,FN,ZQ,Sw,UQ,CL,iP,Hn,Zl,pl,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,I2,RO,xC,dW,IU,b0,Dg,Ob,GV,Pg,fj,Ip,aI,rG,yh,wO,Tm,ib,a9,YL,KC,xL]}